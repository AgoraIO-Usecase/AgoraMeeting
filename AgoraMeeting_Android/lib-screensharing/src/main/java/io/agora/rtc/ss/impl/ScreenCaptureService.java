...
public class ScreenCaptureService extends Service {
    ...
    private InnerBinder mBinder = new InnerBinder();
    ...
    private class InnerBinder extends IScreenCapture.Stub{

        @Override
        public void setOutput(Surface surface, int width, int height) throws RemoteException {
            ScreenCaptureService.this.setSurfaceOutput(surface, width, height);
        }
    ...
    private void initModules() {
        ...
        EglCore rootEglCore = new EglCore(null, 0);
