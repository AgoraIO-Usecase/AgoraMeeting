...
public class ScreenCapture implements SurfaceTexture.OnFrameAvailableListener {
    ...
    public ScreenCapture(Context context, GLRender render, int width, int height, int density) {
        ...
        Logger.d(TAG, "construct init width=" + mWidth + ",height=" + mHeight + ",mScreenDensity=" + mScreenDensity);
    ...
    public void setOutSize(int outWidth, int outHeight) {
        ...
        Logger.d(TAG, "setOutSize outWidth=" + outWidth + ",outHeight=" + outHeight + ",outSizeChange=" + outSizeChange);
    }
        ...
        public void onDrawFrame() {
            ...
            if(outSizeChange){
                ...
                if(outHeight > 0 && outWidth > 0){
                    ...
                    Logger.d("ScreenCapture", "calculateFitCenterMatrix iW=" + mWidth + ",iH=" + mHeight + ",oW=" + outWidth + ",oH=" + outHeight);
