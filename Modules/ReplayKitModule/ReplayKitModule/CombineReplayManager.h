...
typedef NS_OPTIONS(NSUInteger, CombineSyncManagerPauseReason) {
    ...
    //暂停，暂停原因：音视频缓冲
    CombineSyncManagerPauseReasonWaitingVideoReplayerBuffering      = 1 << 1,
    //暂停，暂停原因：主动暂停
    CombineSyncManagerWaitingPauseReasonPlayerPause             = 1 << 2,
    //初始状态，暂停，全缓冲
    CombineSyncManagerPauseReasonInit                           = CombineSyncManagerPauseReasonWaitingWhitePlayerBuffering | CombineSyncManagerPauseReasonWaitingVideoReplayerBuffering | CombineSyncManagerWaitingPauseReasonPlayerPause,
};
